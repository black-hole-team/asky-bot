...
### Для операторов
- `/resolve` - пометить обращение как решенную

### Для администраторов
- `/register_hub` - зарегистрировать новый хаб для обработки заявок
...
2. Реализовать соответствующие возможности (`Capability`)
...
Система построена на основе обработчиков стадий (`StageHandler`). Для добавления новой функциональности:

1. Создайте новый обработчик стадии или расширьте существующий
2. Добавьте новые команды с помощью аннотации `@StageCommand`
...
- Создание хаба в каналах не поддерживающих группы
